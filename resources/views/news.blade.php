...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="mycss1.css" </head>

<body>
    <p class="intro">RoboDog Kendali Jarak Jauh, Inovasi ITS bersama Indosat, Nokia, dan NVIDIA</p>
    ...
    <p class="agakmasuk"> Surabaya, ITS News - <a href="https://www.its.ac.id/" target="_blank">Institut Teknologi
            Sepuluh Nopember
            (ITS)</a> kembali menegaskan kapasitasnya dalam
        pengembangan
    ...
    <p class="publis">Perwakilan Pengembang RoboDog ITS Yuke Brilliant Hestiavin memaparkan bahwa RoboDog dirancang
        mampu menerima
    ...
    <p>Perwakilan Pengembang RoboDog ITS Yuke Brilliant Hestiavin saat mempersiapkan RoboDog untuk demonstrasi
        pengendalian
        jarak jauh di Kantor Indosat Surabaya
    ...
    <p>Partisipasi ITS mencerminkan kapasitas sumber daya manusia dalam merancang inovasi robotika dan kecerdasan buatan
        ...
        juga
        mendukung poin 17 mengenai Kemitraan untuk Mencapai Tujuan. (HUMAS ITS)
    </p>
